...
func _ready() -> void:
	...
	Run.player.capacity_changed.connect(_on_player_capacity_changed)
	set_process(false)
...
func _disable_towers_for_deficit() -> void:
	...
	for tower: Tower in towers:
		var deficit_to_fill: float = -(Run.player.tower_capacity - (Run.player.used_capacity - _capacity_disabled))
...
func _reenable_towers() -> void:
	var capacity_to_reenable: float = Run.player.tower_capacity - (Run.player.used_capacity - _capacity_disabled)
