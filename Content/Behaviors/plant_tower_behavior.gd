...
var _last_report ##adjacency report cache
...
func draw_visuals(canvas: RangeIndicator) -> void:
	...
	if report == null and is_instance_valid(References.island) and is_instance_valid(References.island.topology_service):
