...
@export var active_duration_waves: int = Waves.WAVES_PER_EXPANSION_CHOICE * 3 #this ensures we dont accidentally create a scenario where there are no active breaches
